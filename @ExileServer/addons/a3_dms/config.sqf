...
DMS_Add_MissionCompletion2DB = true;  // Adds Mission Capture for player in the database ;)
...
/* Mission System Settings */
	...
	DMS_MaxBanditMissions				= 1;						// Maximum number of Bandit Missions running at the same time
	DMS_MaxHeroMissions				= 1;						// Maximum number of Bandit Missions running at the same time
	...
	//eXpoch Hero and Bandit and Survivor Marker Attention Circles
	DMS_ShowMarkerAttentionCircle		= true;
	DMS_AttentionCircle_heroColor		= "ColorBlue";
	DMS_AttentionCircle_banditColor		= "ColorRed";
	DMS_AttentionCircle_survivorColor	= "ColorOrange";
	...
	DMS_RandomHeroMissionsOnStart		= 1;
...
/* AI Settings */
	...
	DMS_Show_Party_Capture_Notification = true;					// Whether or not to show in chat when a party member captures a Mission.
